...
create procedure searchPenawaran (varQuery varchar(80))
   reads sql data
begin
   select pos.NamaBarang, usr.RealName, pos.Deskripsi, pen.Harga, pos.Timestamp
...
begin
    ...
    create view permintaan_result as 
        select pos.NamaBarang, usr.RealName, pos.Deskripsi, per.LastNeed, pos.Timestamp
...
-- @return: daftar post permintaan sesuai input
-- ==============================================================================
drop procedure if exists getLogPeminjaman;;
create procedure getLogPeminjaman (varQuery varchar(80))
   reads sql data
begin
    select pos.NamaBarang, usr.RealName, pos.Deskripsi, per.LastNeed, pos.Timestamp
    from post pos natural join permintaan per natural join user usr
...
-- @return: daftar post permintaan sesuai input
-- ==============================================================================
drop procedure if exists getOngoingPeminjaman;;
create procedure getOngoingPeminjaman (varQuery varchar(80))
   reads sql data
begin
    select pos.NamaBarang, usr.RealName, pos.Deskripsi, per.LastNeed, pos.Timestamp
    from post pos natural join permintaan per natural join user usr
