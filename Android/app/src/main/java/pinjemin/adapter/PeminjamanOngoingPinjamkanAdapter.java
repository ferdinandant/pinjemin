...
public class PeminjamanOngoingPinjamkanAdapter
	extends RecyclerView.Adapter<PeminjamanOngoingPinjamkanAdapter.RecyclerViewHolder>
{
	 ...
	 * ============================================================================== */
	public PeminjamanOngoingPinjamkanAdapter(ArrayList<PostPeminjaman> arrayPeminjaman) {
	 ...
	 * ============================================================================== */
	@Override
	public void onBindViewHolder(PeminjamanOngoingPinjamkanAdapter.RecyclerViewHolder holder, int position) {
		PostPeminjaman peminjaman = arrayPeminjaman.get(position);

		holder.namaBarang.setText(peminjaman.getNamaBarang());
		String realname = "Dipinjamkan Kepada " + peminjaman.getRealnamePenerima();
		...
		String status = "Tagih Tanggal " + UtilityDate.formatTimestampDateOnly(peminjaman.getDeadline()) + ", jam " + UtilityDate.formatTimestampTimeOnly(peminjaman.getDeadline());
	...
	{
		TextView namaBarang, realname, status, tanggal, timestamp;
